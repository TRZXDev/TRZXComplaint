...
//
//@interface ComplaintsMsgViewController ()<UITableViewDelegate,UITableViewDataSource,UICollectionViewDelegate,UICollectionViewDataSource,UIImagePickerControllerDelegate,UINavigationControllerDelegate>{
...
//- (void)postData
//{
//    [KipoMyBusinessPlanViewModel getComplaint_ApiReason:self.subType beComplaintId:self.targetId imageArray:self.photoArray Success:^(id json) {
//        
